...
var G = ({ children: e }) => {
  let { resources: t } = N(), r = import_react3.default.useMemo(() => N2(t), [t]);
  return e ? e(r) : import_react3.default.createElement(Routes, null, r);
};
var q = ({ resource: e, meta: t }) => {
  let r = mt(), { resource: i, resources: s } = N(e), n = i || s.find((o) => o.list);
  if (n) {
